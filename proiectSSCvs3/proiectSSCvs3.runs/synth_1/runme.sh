...
HD_PWD='C:/Users/Adina-PC/Desktop/SSC/proiectSSCvs3/proiectSSCvs3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floatingPointAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floatingPointAdder.tcl
